    ...
    <div class="row g-4">
      <div class="bg-secondary text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="" class="text-light me-4">Show All</a>
            ...
            <tbody>
              ...
              foreach ($allClients as $client) : ?>
                ...
                <tr>
                  ...
                  <td><a href="clientprojects.php?clientid=<?php echo $clientId; ?>" class="text-light" target="_blank">Projects</a></td>
                </tr>
              <?php endforeach ?>
            </tbody>
          </table>
